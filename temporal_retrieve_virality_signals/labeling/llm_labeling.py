...
async def get_chat_completion(
    ...
    """
    Один запрос к LLM.
    Берём текст item[text_col], подставляем в SYSTEM_PROMPT из system_promt.py
    и ожидаем один JSON-объект в ответе.
    """
...
async def async_main(cfg: DictConfig) -> None:
    ...
    # === читаем настройки из старого конфига, с fallback'ами ===
    ...
    # работаем только с текстовой колонкой, дедуп по тексту
    ...
    # === сохраняем только text_col + llm_raw + llm_json ===
